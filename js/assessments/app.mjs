...
function saveControl() { return `<label class="ac-check ac-no-print"><input type="checkbox" id="ac-saving"${saving?' checked':''}${response.demo?' disabled':''}><span>Save answers, evidence notes, and results in this browser. Anyone using this browser profile may access them.</span></label>`; }
