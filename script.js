...
const phases = [
  {
    id: "cognitive",
    title: "Conditions for Change Layer",
    description: "Notice time, resources, cognitive capacity, emotional readiness, social environment, habits, routines, and agency.",
  },
  {
    id: "trust",
    title: "Trust Layer",
  ...
  {
    id: "adoption",
    title: "Agency and Choice Layer",
    description: "Identify meaningful choices, change comfort, support needs, and barriers that shape how people respond.",
  },
  {
    id: "plus",
    title: "Learning and Adaptation Layer",
    description: "Look at motivation, feedback, consistency, and what helps learning become sustained change.",
  },
  {
    id: "environment",
    title: "Social Environment and Routine Layer",
    description: "Spot work, learning, care, or daily-life conditions that make systems harder than they need to be.",
  },
];
...
const buildLayerNarratives = (phaseScores, indicatorSummary, selectedTasks = [], answerAnalysis = {}) => {
  ...
  return phases.map((phase) => {
    ...
    if (phase.id === "adoption") {
      ...
      barriers.push("Agency can feel smaller when learning something new brings too many features before the basic steps feel clear.");
      recommendations.push("Pick one tool, one task, and one short practice window so the next choice is visible instead of overwhelming.");
    ...
    if (phase.id === "environment") {
      ...
      barriers.push("If social expectations, handoffs, or routines are already messy, adding AI can create more confusion instead of reducing it.");
      recommendations.push("Clean up the most confusing condition first, then use AI to draft, organize, remind, or summarize.");
...
const getImplementationPath = (assessmentId, indicatorSummary, answerAnalysis = {}) => {
  ...
  const steps = [
    "Start by naming the conditions shaping readiness: time, resources, cognitive capacity, emotional readiness, social environment, habits, routines, and agency.",
